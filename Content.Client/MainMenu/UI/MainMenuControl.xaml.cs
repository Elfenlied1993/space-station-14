    ...
    public sealed partial class MainMenuControl : Control
        {
            ...
            LayoutContainer.SetAnchorPreset(MapListBox, LayoutContainer.LayoutPreset.TopLeft);
            LayoutContainer.SetMarginLeft(MapListBox, 25);
            LayoutContainer.SetMarginTop(MapListBox, 30);
